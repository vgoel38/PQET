 ...
 [                                                                             +
   {                                                                           +
     "Plan": {                                                                 +
       ...
       "Plan Rows": 1,                                                         +
       "Plan Width": 64,                                                       +
       "Actual Startup Time": 61706.743,                                       +
       "Actual Total Time": 61706.743,                                         +
       "Actual Rows": 1,                                                       +
       "Actual Loops": 1,                                                      +
       ...
       "Plans": [                                                              +
         {                                                                     +
           ...
           "Plan Rows": 9,                                                     +
           "Plan Width": 23,                                                   +
           "Actual Startup Time": 6911.821,                                    +
           "Actual Total Time": 61692.212,                                     +
           "Actual Rows": 740,                                                 +
           "Actual Loops": 1,                                                  +
           "Inner Unique": true,                                               +
           ...
           "Plans": [                                                          +
             {                                                                 +
               ...
               "Plan Rows": 23,                                                +
               "Plan Width": 14,                                               +
               "Actual Startup Time": 6331.748,                                +
               "Actual Total Time": 7280.464,                                  +
               "Actual Rows": 5820,                                            +
               "Actual Loops": 1,                                              +
               "Inner Unique": true,                                           +
               ...
               "Plans": [                                                      +
                 {                                                             +
                   ...
                   "Plan Rows": 45532,                                         +
                   "Plan Width": 18,                                           +
                   "Actual Startup Time": 6147.698,                            +
                   "Actual Total Time": 6638.397,                              +
                   "Actual Rows": 2877469,                                     +
                   "Actual Loops": 1,                                          +
                 ...
                 {                                                             +
                   ...
                   "Plan Rows": 67,                                            +
                   "Plan Width": 4,                                            +
                   "Actual Startup Time": 87.431,                              +
                   "Actual Total Time": 87.446,                                +
                   "Actual Rows": 30,                                          +
                   "Actual Loops": 1,                                          +
                   "Sort Key": ["k.id"],                                       +
                   "Sort Method": "quicksort",                                 +
                   ...
                   "Plans": [                                                  +
                     {                                                         +
                       ...
                       "Plan Rows": 67,                                        +
                       "Plan Width": 4,                                        +
                       "Actual Startup Time": 26.269,                          +
                       "Actual Total Time": 87.387,                            +
                       "Actual Rows": 30,                                      +
                       "Actual Loops": 1,                                      +
             ...
             {                                                                 +
               ...
               "Plan Rows": 1,                                                 +
               "Plan Width": 21,                                               +
               "Actual Startup Time": 9.345,                                   +
               "Actual Total Time": 9.345,                                     +
               "Actual Rows": 0,                                               +
               "Actual Loops": 5820,                                           +
     ...
     "Planning Time": 2329.211,                                                +
     "Triggers": [                                                             +
     ],                                                                        +
     "Execution Time": 61746.654                                               +
   }                                                                           +
 ]
(1 row)

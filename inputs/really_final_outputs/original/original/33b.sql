                                                         ...
                                                         ->  Hash Join  (cost=523.37..534.11 rows=22 width=22) (actual time=683.358..731.144 rows=34 loops=1)
                                                               ...
                                                               ->  Hash Join  (cost=523.34..534.04 rows=387 width=26) (actual time=672.621..730.643 rows=1085 loops=1)
                                                                     ...
                                                                     ->  Hash  (cost=522.48..522.48 rows=5826 width=14) (actual time=672.562..672.562 rows=25591 loops=1)
                                                                           ...
                                                                           ->  Nested Loop  (cost=0.05..522.48 rows=5826 width=14) (actual time=0.067..661.348 rows=25591 loops=1)
                                                                                 Buffers: shared hit=4 read=8451
                                                                                 ->  Seq Scan on info_type it  (cost=0.00..0.05 rows=1 width=4) (actual time=0.014..0.017 rows=1 loops=1)
                                                                                 ...
                                                                                 ->  Hash Join  (cost=0.05..522.03 rows=5826 width=10) (actual time=0.051..654.498 rows=25591 loops=1)
                                                                                       ...
                                                                                       ->  Seq Scan on movie_info_idx mi_idx  (cost=0.00..467.71 rows=658313 width=14) (actual time=0.005..550.446 rows=658295 loops=1)
                                                               ...
                                                               ->  Hash  (cost=0.03..0.03 rows=1 width=4) (actual time=0.023..0.023 rows=2 loops=1)
                                                                     ...
                                                                     ->  Seq Scan on link_type lt  (cost=0.00..0.03 rows=1 width=4) (actual time=0.014..0.018 rows=2 loops=1)
                                                                           ...
                                                                           Buffers: shared hit=1
                                                         ->  Index Scan using title_idx_id on title t  (cost=0.01..0.21 rows=1 width=25) (actual time=26.059..26.059 rows=0 loops=34)
                                                               Index Cond: (id = mi_idx.movie_id)
                                                               Filter: (production_year = 2007)
                                                               Rows Removed by Filter: 1
                                                               Buffers: shared hit=79 read=57
                                                   ->  Index Scan using kind_type_pkey on kind_type kt  (cost=0.00..0.00 rows=1 width=4) (actual time=0.019..0.019 rows=1 loops=2)
                                                         Index Cond: (id = t.kind_id)
                                                         Filter: ((kind)::text = 'tv series'::text)
                                                         Buffers: shared hit=4
                                             ->  Seq Scan on kind_type kt  (cost=0.00..0.03 rows=1 width=4) (actual time=0.007..0.012 rows=1 loops=2)
                                                   Filter: ((kind)::text = 'tv series'::text)
                                                   Rows Removed by Filter: 6
                                                   Buffers: shared hit=2
                                       ->  Index Scan using title_idx_id on title t  (cost=0.01..2.88 rows=1 width=25) (actual time=12.020..12.020 rows=1 loops=2)
                                             Index Cond: (id = ml.movie_id)
                                             Buffers: shared hit=4 read=4
                                 ->  Index Scan using movie_companies_idx_mid on movie_companies mc  (cost=0.01..0.05 rows=2 width=8) (actual time=25.936..25.989 rows=2 loops=2)
                                       Index Cond: (movie_id = t.id)
                                       Buffers: shared hit=4 read=5
                           ->  Index Scan using movie_companies_idx_mid on movie_companies mc  (cost=0.01..0.13 rows=2 width=8) (actual time=7.841..9.991 rows=4 loops=4)

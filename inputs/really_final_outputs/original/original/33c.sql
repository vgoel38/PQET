                                             ...
                                             ->  Hash Join  (cost=571.55..597.53 rows=8 width=43) (actual time=764.163..1748.079 rows=21 loops=1)
                                                   ...
                                                   ->  Nested Loop  (cost=571.52..597.50 rows=28 width=47) (actual time=662.345..1747.876 rows=29 loops=1)
                                                         ...
                                                         ->  Nested Loop  (cost=571.50..583.71 rows=69 width=22) (actual time=629.259..651.644 rows=47 loops=1)
                                                               ...
                                                               ->  Seq Scan on info_type it  (cost=0.00..0.05 rows=1 width=4) (actual time=0.044..0.055 rows=1 loops=1)
                                                               ...
                                                               ->  Hash Join  (cost=571.50..583.66 rows=69 width=18) (actual time=629.210..651.532 rows=47 loops=1)
                                                                     ...
                                                                     ->  Hash Join  (cost=571.46..582.97 rows=7827 width=22) (actual time=611.109..650.389 rows=3080 loops=1)
                                                                           ...
                                                                           ->  Hash  (cost=467.71..467.71 rows=706570 width=14) (actual time=605.961..605.961 rows=706560 loops=1)
                                                                                 ...
                                                                                 ->  Seq Scan on movie_info_idx mi_idx  (cost=0.00..467.71 rows=706570 width=14) (actual time=0.010..393.874 rows=706560 loops=1)
                                                                     ...
                                                                     ->  Hash  (cost=0.05..0.05 rows=1 width=4) (actual time=0.051..0.051 rows=1 loops=1)
                                                                           Buckets: 1024  Batches: 1  Memory Usage: 9kB
                                                                           Buffers: shared hit=1
                                                                           ->  Seq Scan on info_type it  (cost=0.00..0.05 rows=1 width=4) (actual time=0.041..0.046 rows=1 loops=1)
                                                                                 Filter: ((info)::text = 'rating'::text)
                                                                                 Rows Removed by Filter: 112
                                                                                 Buffers: shared hit=1
                                                         ->  Index Scan using title_idx_id on title t  (cost=0.01..0.20 rows=1 width=25) (actual time=23.319..23.319 rows=1 loops=47)
                                                   ...
                                                   ->  Hash  (cost=0.03..0.03 rows=2 width=4) (actual time=0.035..0.036 rows=2 loops=1)
                                                         Buckets: 1024  Batches: 1  Memory Usage: 9kB
                                                         Buffers: shared hit=1
                                                         ->  Seq Scan on kind_type kt  (cost=0.00..0.03 rows=2 width=4) (actual time=0.017..0.022 rows=2 loops=1)
                                                               Filter: ((kind)::text = ANY ('{"tv series",episode}'::text[]))
                                                               Rows Removed by Filter: 5
                                                               Buffers: shared hit=1
                                             ->  Index Scan using movie_companies_idx_mid on movie_companies mc  (cost=0.01..0.09 rows=2 width=8) (actual time=13.530..15.300 rows=2 loops=21)
                                                   Index Cond: (movie_id = t.id)
                                                   Buffers: shared hit=69 read=29
                                       ->  Index Scan using movie_info_idx_idx_mid on movie_info_idx mi_idx  (cost=0.01..1.26 rows=3 width=14) (actual time=2.437..2.440 rows=3 loops=48)
                                             Index Cond: (movie_id = ml.movie_id)
                                             Buffers: shared hit=177 read=11
                                 ->  Index Scan using title_idx_id on title t  (cost=0.01..0.11 rows=1 width=25) (actual time=2.451..2.451 rows=1 loops=44)
                                       Index Cond: (id = mi_idx.movie_id)
                                       Buffers: shared hit=160 read=16
                           ->  Index Scan using kind_type_pkey on kind_type kt  (cost=0.00..0.00 rows=1 width=4) (actual time=0.008..0.008 rows=1 loops=44)

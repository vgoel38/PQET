                                                   ...
                                                   ->  Nested Loop  (cost=564.43..598.99 rows=11 width=47) (actual time=863.415..1720.499 rows=6 loops=1)
                                                         ...
                                                         ->  Hash Join  (cost=564.42..585.33 rows=64 width=22) (actual time=824.010..903.875 rows=34 loops=1)
                                                               ...
                                                               ->  Nested Loop  (cost=564.39..585.27 rows=387 width=26) (actual time=809.856..903.318 rows=1085 loops=1)
                                                                     ...
                                                                     ->  Seq Scan on info_type it1  (cost=0.00..0.05 rows=1 width=4) (actual time=26.688..26.700 rows=1 loops=1)
                                                                     ...
                                                                     ->  Hash Join  (cost=564.39..585.19 rows=387 width=22) (actual time=783.164..876.073 rows=1085 loops=1)
                                                                           ...
                                                                           ->  Hash Join  (cost=564.34..581.54 rows=43752 width=26) (actual time=783.039..864.383 rows=38117 loops=1)
                                                                                 ...
                                                                                 ->  Hash  (cost=467.71..467.71 rows=658313 width=14) (actual time=776.976..776.976 rows=658295 loops=1)
                                                                                       ...
                                                                                       ->  Seq Scan on movie_info_idx mi_idx2  (cost=0.00..467.71 rows=658313 width=14) (actual time=11.307..561.962 rows=658295 loops=1)
                                                               ...
                                                               ->  Hash  (cost=0.03..0.03 rows=3 width=4) (actual time=0.081..0.081 rows=2 loops=1)
                                                                     ...
                                                                     ->  Seq Scan on link_type lt  (cost=0.00..0.03 rows=3 width=4) (actual time=0.073..0.077 rows=2 loops=1)
                                                                           ...
                                                                           Buffers: shared read=1
                                                         ->  Index Scan using title_idx_id on title t2  (cost=0.01..0.21 rows=1 width=25) (actual time=24.013..24.013 rows=0 loops=34)
                                                               Index Cond: (id = mi_idx2.movie_id)
                                                               Filter: ((production_year >= 2005) AND (production_year <= 2008))
                                                               Rows Removed by Filter: 1
                                                               Buffers: shared hit=77 read=59
                                                   ->  Index Scan using movie_id_movie_companies on movie_companies mc2  (cost=0.01..0.13 rows=2 width=8) (actual time=15.933..18.627 rows=2 loops=6)
                                                         Index Cond: (movie_id = mi_idx2.movie_id)
                                                         Buffers: shared hit=13 read=14
                                             ->  Index Scan using movie_id_movie_info_idx on movie_info_idx mi_idx1  (cost=0.01..1.26 rows=3 width=14) (actual time=6.494..6.497 rows=3 loops=11)
                                                   Index Cond: (movie_id = ml.movie_id)
                                                   Buffers: shared hit=35 read=8
                                       ->  Index Scan using title_idx_id on title t1  (cost=0.01..0.11 rows=1 width=25) (actual time=7.267..7.267 rows=1 loops=10)
                                             Index Cond: (id = mi_idx1.movie_id)
                                             Buffers: shared hit=31 read=9
                                 ->  Index Scan using kind_type_pkey on kind_type kt2  (cost=0.00..0.00 rows=1 width=4) (actual time=2.309..2.309 rows=1 loops=10)
                                       Index Cond: (id = t2.kind_id)
                                       Filter: ((kind)::text = 'tv series'::text)
                                       Buffers: shared hit=18 read=2
                           ->  Index Scan using company_name_pkey on company_name cn2  (cost=0.01..0.02 rows=1 width=23) (actual time=10.150..10.150 rows=1 loops=10)
                                 Index Cond: (id = mc2.company_id)
                                 Buffers: shared hit=26 read=14
                     ->  Index Scan using movie_id_movie_companies on movie_companies mc1  (cost=0.01..0.05 rows=2 width=8) (actual time=4.165..4.890 rows=3 loops=10)
                           Index Cond: (movie_id = t1.id)
                           Buffers: shared hit=36 read=12
               ->  Index Scan using company_name_pkey on company_name cn1  (cost=0.01..0.02 rows=1 width=23) (actual time=4.820..4.820 rows=0 loops=28)
                     Index Cond: (id = mc1.company_id)
                     Filter: ((country_code)::text = '[us]'::text)
                     Rows Removed by Filter: 1
                     Buffers: shared hit=94 read=18
         ->  Index Scan using kind_type_pkey on kind_type kt1  (cost=0.00..0.00 rows=1 width=4) (actual time=0.009..0.009 rows=1 loops=8)

...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 Aggregate  (cost=983.71..983.71 rows=1 width=192) (actual time=12787.149..12787.149 rows=1 loops=1)
   ...
   ->  Nested Loop  (cost=0.14..983.71 rows=1 width=84) (actual time=2933.671..12787.091 rows=8 loops=1)
               ...
               ->  Nested Loop  (cost=0.11..983.67 rows=1 width=79) (actual time=597.649..12562.785 rows=465 loops=1)
                     ...
                     ->  Nested Loop  (cost=0.10..983.47 rows=1 width=71) (actual time=597.638..12293.922 rows=58 loops=1)
                           ...
                           ->  Nested Loop  (cost=0.09..983.46 rows=3 width=75) (actual time=343.594..12292.790 rows=131 loops=1)
                                 ...
                                 ->  Index Scan using info_type_pkey on info_type it2  (cost=0.00..9.21 rows=1 width=4) (actual time=0.088..0.093 rows=1 loops=1)
                                 ...
                                 ->  Nested Loop  (cost=0.09..974.25 rows=3 width=71) (actual time=343.500..12292.542 rows=131 loops=1)
                                       ...
                                       ->  Nested Loop  (cost=0.07..925.27 rows=17 width=46) (actual time=246.704..5286.289 rows=1849 loops=1)
                                             ...
                                             ->  Nested Loop  (cost=0.07..924.76 rows=116 width=50) (actual time=246.661..5273.085 rows=2083 loops=1)
                                                               ...
                                                               ->  Nested Loop  (cost=0.04..13743.70 rows=10637 width=33) (actual time=0.138..3152.766 rows=25899 loops=1)
                                                                     ...
                                                                     ->  Nested Loop  (cost=0.03..13218.84 rows=29462 width=18) (actual time=0.114..518.195 rows=47761 loops=1)
                                                                           ...
                                                                           ->  Nested Loop  (cost=0.02..12346.83 rows=12213 width=10) (actual time=0.091..199.717 rows=21301 loops=1)
                                                                                 ...
                                                                                 ->  Index Scan using movie_id_movie_info_idx on movie_info_idx mi_idx1  (cost=0.01..12031.00 rows=1380035 width=14) (actual time=0.029..127.132 rows=63903 loops=1)
                                                                                       Buffers: shared hit=266 read=560
                                                                                 ->  Materialize  (cost=0.00..6.13 rows=1 width=4) (actual time=0.000..0.000 rows=1 loops=63903)
                                                                                       Buffers: shared hit=1 read=1
                                                                                       ->  Index Scan using info_type_info_key on info_type it1  (cost=0.00..6.13 rows=1 width=4) (actual time=0.041..0.042 rows=1 loops=1)
                                                                                             Index Cond: ((info)::text = 'rating'::text)
                                                                                             Buffers: shared hit=1 read=1
                                                                           ->  Index Scan using movie_id_movie_companies on movie_companies mc1  (cost=0.01..0.07 rows=2 width=8) (actual time=0.009..0.013 rows=2 loops=21301)
                                                   ...
                                                   ->  Index Scan using title_idx_id on title t1  (cost=0.01..0.06 rows=1 width=25) (actual time=0.844..0.844 rows=1 loops=2083)
                                                         Index Cond: (id = mc1.movie_id)
                                                         Buffers: shared hit=8080 read=256
                                             ->  Index Scan using kind_type_pkey on kind_type kt1  (cost=0.00..0.00 rows=1 width=4) (actual time=0.004..0.004 rows=1 loops=2083)
                                                   Index Cond: (id = t1.kind_id)
                                                   Filter: ((kind)::text = 'tv series'::text)
                                                   Rows Removed by Filter: 0
                                                   Buffers: shared hit=4166
                                       ->  Index Scan using title_idx_id on title t2  (cost=0.01..2.88 rows=1 width=25) (actual time=3.788..3.788 rows=0 loops=1849)
                                             Index Cond: (id = ml.linked_movie_id)
                                             Filter: ((production_year >= 2005) AND (production_year <= 2008))
                                             Rows Removed by Filter: 1
                                             Buffers: shared hit=6780 read=621
                           ->  Index Scan using kind_type_pkey on kind_type kt2  (cost=0.00..0.00 rows=1 width=4) (actual time=0.006..0.006 rows=0 loops=131)
                                 Index Cond: (id = t2.kind_id)
                                 Filter: ((kind)::text = 'tv series'::text)
                                 Rows Removed by Filter: 1
                                 Buffers: shared hit=262
                     ->  Index Scan using movie_id_movie_companies on movie_companies mc2  (cost=0.01..0.19 rows=2 width=8) (actual time=2.431..4.627 rows=8 loops=58)
         ...
         ->  Index Scan using movie_id_movie_info_idx on movie_info_idx mi_idx2  (cost=0.01..0.03 rows=1 width=14) (actual time=0.388..0.390 rows=2 loops=465)

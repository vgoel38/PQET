   ...
   ->  Nested Loop  (cost=0.14..883.89 rows=1 width=84) (actual time=1262.228..6049.674 rows=4 loops=1)
         ...
         ->  Nested Loop  (cost=0.12..883.86 rows=1 width=94) (actual time=1262.146..6049.543 rows=4 loops=1)
               ...
               ->  Nested Loop  (cost=0.12..883.86 rows=1 width=98) (actual time=1262.089..6049.464 rows=4 loops=1)
                                 ...
                                 ->  Nested Loop  (cost=0.08..883.10 rows=1 width=66) (actual time=1256.764..6044.027 rows=1 loops=1)
                                       ...
                                       ->  Nested Loop  (cost=0.08..883.09 rows=1 width=70) (actual time=175.062..6043.891 rows=6 loops=1)
                                             ...
                                             ->  Nested Loop  (cost=0.06..877.33 rows=2 width=45) (actual time=71.883..2540.684 rows=477 loops=1)
                                                   ...
                                                   ->  Index Scan using info_type_pkey on info_type it2  (cost=0.00..9.21 rows=1 width=4) (actual time=0.031..0.047 rows=1 loops=1)
                                                               ...
                                                               ->  Nested Loop  (cost=0.03..861.43 rows=44 width=18) (actual time=0.108..259.612 rows=2064 loops=1)
                                                                           ...
                                                                           ->  Nested Loop  (cost=0.01..291.72 rows=1666 width=8) (actual time=0.050..86.347 rows=2315 loops=1)
                                                                                 ...
                                                                                 ->  Materialize  (cost=0.00..9.19 rows=1 width=4) (actual time=0.000..0.000 rows=2 loops=29997)
                                                                                       ...
                                                                                       ->  Index Scan using link_type_pkey on link_type lt  (cost=0.00..9.19 rows=1 width=4) (actual time=0.005..0.011 rows=2 loops=1)
                                                                                             ...
                                                                                             Buffers: shared hit=2
                                                                           ->  Index Scan using movie_id_movie_info_idx on movie_info_idx mi_idx1  (cost=0.01..12031.00 rows=1380035 width=14) (actual time=0.008..144.152 rows=68653 loops=1)
                                                                     ...
                                                                     ->  Materialize  (cost=0.00..6.13 rows=1 width=4) (actual time=0.000..0.000 rows=1 loops=6192)
                                                                           ...
                                                                           ->  Index Scan using info_type_info_key on info_type it1  (cost=0.00..6.13 rows=1 width=4) (actual time=0.015..0.015 rows=1 loops=1)
                                                                                 ...
                                                                                 Buffers: shared hit=1 read=1
                                                               ->  Index Scan using movie_id_movie_companies on movie_companies mc1  (cost=0.01..0.07 rows=2 width=8) (actual time=0.067..0.081 rows=5 loops=2064)
                                             ...
                                             ->  Index Scan using title_idx_id on title t2  (cost=0.01..2.88 rows=1 width=25) (actual time=7.343..7.343 rows=0 loops=477)
                                                   Index Cond: (id = ml.linked_movie_id)
                                                   Filter: (production_year = 2007)
                                                   Rows Removed by Filter: 1
                                                   Buffers: shared hit=1628 read=286
                                       ->  Index Scan using kind_type_pkey on kind_type kt2  (cost=0.00..0.00 rows=1 width=4) (actual time=0.016..0.016 rows=0 loops=6)
                                             Index Cond: (id = t2.kind_id)
                                             Filter: ((kind)::text = 'tv series'::text)
                                             Rows Removed by Filter: 1
                                             Buffers: shared hit=12
                                 ->  Index Scan using movie_id_movie_companies on movie_companies mc2  (cost=0.01..0.68 rows=2 width=8) (actual time=0.178..0.200 rows=4 loops=1)
                     ...
                     ->  Index Scan using title_idx_id on title t1  (cost=0.01..0.06 rows=1 width=25) (actual time=1.280..1.280 rows=1 loops=4)
                           Index Cond: (id = mc1.movie_id)
                           Buffers: shared hit=14 read=2
               ->  Index Scan using kind_type_pkey on kind_type kt1  (cost=0.00..0.00 rows=1 width=4) (actual time=0.015..0.015 rows=1 loops=4)
                     Index Cond: (id = t1.kind_id)
                     Filter: ((kind)::text = 'tv series'::text)
                     Buffers: shared hit=8
         ->  Index Scan using movie_id_movie_info_idx on movie_info_idx mi_idx2  (cost=0.01..0.03 rows=1 width=14) (actual time=0.025..0.028 rows=2 loops=4)

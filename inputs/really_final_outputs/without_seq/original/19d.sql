                                                                                                  QUERY PLAN                                                                                                  
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 Aggregate  (cost=43234.19..43234.19 rows=1 width=64) (actual time=716362.939..716362.940 rows=1 loops=1)
   Buffers: shared hit=19395385 read=148207
   ->  Nested Loop  (cost=0.12..43234.11 rows=480 width=32) (actual time=597.453..715420.400 rows=1760645 loops=1)
         Join Filter: (ci.person_id = n.id)
         Buffers: shared hit=19395385 read=148207
         ->  Nested Loop  (cost=0.11..42705.92 rows=2080 width=25) (actual time=576.212..695967.186 rows=1761514 loops=1)
               ...
               ->  Nested Loop  (cost=0.10..42665.30 rows=235007 width=29) (actual time=562.274..693819.425 rows=10346042 loops=1)
                     Join Filter: (t.id = mi.movie_id)
                     Buffers: shared hit=12351053 read=143396
                     ->  Nested Loop  (cost=0.09..39734.98 rows=11532 width=37) (actual time=531.372..427482.798 rows=266076 loops=1)
                           Buffers: shared hit=8953828 read=112629
                           ->  Nested Loop  (cost=0.07..38384.74 rows=21106 width=16) (actual time=383.911..263956.254 rows=483198 loops=1)
                                 Buffers: shared hit=7035798 read=96439
                                 ->  Nested Loop  (cost=0.06..37343.31 rows=58459 width=20) (actual time=250.455..230391.084 rows=910376 loops=1)
                                       Buffers: shared hit=3396632 read=92932
                                       ->  Nested Loop  (cost=0.05..34129.44 rows=30437 width=12) (actual time=209.749..63726.210 rows=483319 loops=1)
                                             Buffers: shared hit=1548768 read=77887
                                             ->  Nested Loop  (cost=0.04..33343.32 rows=35008 width=8) (actual time=114.567..61474.272 rows=255651 loops=1)
                                                   Buffers: shared hit=781605 read=77335
                                                   ->  Nested Loop  (cost=0.02..29509.08 rows=72136 width=12) (actual time=79.396..7607.723 rows=276166 loops=1)
                                                         ...
                                                         ->  Index Scan using role_type_role_key on role_type rt  (cost=0.00..6.12 rows=1 width=4) (actual time=0.012..0.013 rows=1 loops=1)
                                                               ...
                                                               Buffers: shared hit=1 read=1
                                                         ->  Index Scan using role_id_cast_info on cast_info ci  (cost=0.02..29497.51 rows=78694 width=16) (actual time=79.380..7473.917 rows=276166 loops=1)
                                       ...
                                       ->  Index Scan using movie_id_movie_companies on movie_companies mc  (cost=0.01..0.11 rows=2 width=8) (actual time=0.265..0.343 rows=2 loops=483319)
                           ...
                           ->  Index Scan using title_idx_id on title t  (cost=0.01..0.06 rows=1 width=21) (actual time=0.337..0.337 rows=1 loops=483198)
 ...
 Planning Time: 7338.022 ms
 Execution Time: 716363.426 ms
(66 rows)
